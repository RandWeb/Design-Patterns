...
public class SampleCollections
{
    ...
    public static List<string> Numbers = new() { "One", "Two", "Three", "Four", "Five" };
    public static List<string> Numbers2 = new() { "One", "Two", "three", "Four", "Five" };

    public static List<int> Digits = new() { 1, 2, 3, 4, 5, 6, 7, 8 };

    public static List<Motor> MotorSet = new()
    {
        new Motor()
        {
            MotorType = MotorType.Gas,
    ...
    public static List<Motor> MotorSet2 = new()
    {
        new Motor()
        {
            MotorType = MotorType.Gas,
    ...
    public static List<Motor> EqualMotorSet = new()
    {
        new Motor()
        {
            MotorType = MotorType.Gas,
    ...
    public static List<int> DigitsWithDuplicate = new() { 1, 2, 3, 4, 5, 7, 2, 4, 5, 1, 8, 11, 35, 16 };

    public static List<object> Persons { get; set; } = new()
    {
    ...
    {
        new Student { Id = 1, FirstName = "Mehrdad", LastName = "Mohammadi", NationalCode = "1234567890", Age = 20 },
        ...
        new Student { Id = 4, FirstName = "mehrdad", LastName = "Tabesh", NationalCode = "333333", Age = 32 },
    ...
    {
        new() { Id = 1, FirstName = "Milad", LastName = "Mohammadi", NationalCode = "1234567890", Age = 20 },
        new() { Id = 2, FirstName = "ali", LastName = "ezati", NationalCode = "222222222", Age = 19 },
        new() { Id = 13, FirstName = "reza", LastName = "abdi", NationalCode = "999999999", Age = 15 },
        new() { Id = 4, FirstName = "akbar", LastName = "abdi", NationalCode = "333333", Age = 32 },
        new() { Id = 55, FirstName = "mani", LastName = "milani", NationalCode = "45967824587678", Age = 14 },
        new() { Id = 6, FirstName = "reza", LastName = "rezaei", NationalCode = "124527866738", Age = 12 },
        new() { Id = 72, FirstName = "naghi", LastName = "mamooli", NationalCode = "1245863787", Age = 9 },
        new() { Id = 81, FirstName = "mehran", LastName = "ghafoorian", NationalCode = "5555558888999", Age = 21 }
    };
    ...
    public static List<Mark> Marks { get; set; } = new()
    {
    ...
    public static List<Teacher> Teachers { get; set; } = new()
    {
        ...
        new Teacher()
        {
            Id = 2, FirstName = "akbar", LastName = "Dehghan",
            Educations = new List<Education>
            {
                new() { Title = "bachelor" },
                new() { Title = "Master" },
    ...
    public static List<Student> EmptyStudents { get; set; } = new();

    public static List<Student> SingleItemStudents { get; set; } = new()
    {
    ...
    {
        foreach (var item in dictionary) Console.WriteLine($"key: {item.Key} value: {item.ToString()}");
    }
